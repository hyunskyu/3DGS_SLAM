...
from utils.graphics_utils import getProjectionMatrix2, getWorld2View2_tensor
...
class Camera(nn.Module):
    ...
    def world_view_transform(self):
        return getWorld2View2_tensor(self.R, self.T).transpose(0, 1)
